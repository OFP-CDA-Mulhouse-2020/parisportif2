 ...
 */
final class Version20210121105512 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card_id_file (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, is_card_id_valid TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
